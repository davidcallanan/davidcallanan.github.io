import{S as C,i as N,s as q,k as i,q as P,a as A,l as w,m as y,r as L,h as l,c as B,p as D,n,b as I,E as r,A as G,L as x,C as V}from"../../../chunks/index-46e3bee9.js";function j(p,e,o){const _=p.slice();return _[1]=e[o],_}function W(p){let e,o,_=p[1].name+"",T,k,h,u,b,E,d,c,f;return{c(){e=i("div"),o=i("h1"),T=P(_),k=A(),h=i("a"),u=i("img"),E=A(),d=i("a"),c=i("img"),this.h()},l(g){e=w(g,"DIV",{class:!0});var a=y(e);o=w(a,"H1",{class:!0});var O=y(o);T=L(O,_),O.forEach(l),k=B(a),h=w(a,"A",{href:!0,target:!0});var v=y(h);u=w(v,"IMG",{src:!0,class:!0,alt:!0}),v.forEach(l),E=B(a),d=w(a,"A",{href:!0,target:!0});var m=y(d);c=w(m,"IMG",{src:!0,class:!0,alt:!0}),m.forEach(l),a.forEach(l),this.h()},h(){n(o,"class","svelte-1pdeuuj"),V(u.src,b="/imdb.png")||n(u,"src",b),n(u,"class","img-imdb svelte-1pdeuuj"),n(u,"alt","IMDb Link"),n(h,"href",p[1].imdb_url),n(h,"target","_blank"),V(c.src,f="/rotten.png")||n(c,"src",f),n(c,"class","img-rotten svelte-1pdeuuj"),n(c,"alt","Rotten Tomatoes Link"),n(d,"href",p[1].rotten_tomatoes_url),n(d,"target","_blank"),n(e,"class","movie svelte-1pdeuuj")},m(g,a){I(g,e,a),r(e,o),r(o,T),r(e,k),r(e,h),r(h,u),r(e,E),r(e,d),r(d,c)},p:G,d(g){g&&l(e)}}}function z(p){let e,o,_,T,k,h,u,b,E,d,c,f,g,a,O,v=p[0],m=[];for(let s=0;s<v.length;s+=1)m[s]=W(j(p,v,s));return{c(){e=i("div"),o=i("div"),_=i("h2"),T=P("All-Time Movies & TV Shows"),k=P(`
		\xA0
		`),h=i("hr"),u=A(),b=i("pre"),E=P(`(in alphabetical order)

[MOVIES]

First-tier movies (most emotionally impactful):
`),d=A();for(let s=0;s<m.length;s+=1)m[s].c();c=A(),f=i("pre"),g=P(`
...
The Office US
		`),a=A(),O=i("br"),this.h()},l(s){e=w(s,"DIV",{class:!0});var S=y(e);o=w(S,"DIV",{class:!0});var t=y(o);_=w(t,"H2",{style:!0});var H=y(_);T=L(H,"All-Time Movies & TV Shows"),H.forEach(l),k=L(t,`
		\xA0
		`),h=w(t,"HR",{}),u=B(t),b=w(t,"PRE",{style:!0,class:!0});var F=y(b);E=L(F,`(in alphabetical order)

[MOVIES]

First-tier movies (most emotionally impactful):
`),F.forEach(l),d=B(t);for(let M=0;M<m.length;M+=1)m[M].l(t);c=B(t),f=w(t,"PRE",{style:!0,class:!0});var R=y(f);g=L(R,`
Second-tier movies (other movies):
