import{S as C,i as N,s as q,k as i,q as I,a as B,l as _,m as y,r as L,h as l,c as H,p as P,n,b as M,E as s,A as V,L as x,C as G}from"../../../chunks/index-e9506ef8.js";function R(p,e,o){const w=p.slice();return w[1]=e[o],w}function W(p){let e,o,w=p[1].name+"",T,k,h,u,b,E,d,c,f;return{c(){e=i("div"),o=i("h1"),T=I(w),k=B(),h=i("a"),u=i("img"),E=B(),d=i("a"),c=i("img"),this.h()},l(g){e=_(g,"DIV",{class:!0});var m=y(e);o=_(m,"H1",{class:!0});var O=y(o);T=L(O,w),O.forEach(l),k=H(m),h=_(m,"A",{href:!0,target:!0});var v=y(h);u=_(v,"IMG",{src:!0,class:!0,alt:!0}),v.forEach(l),E=H(m),d=_(m,"A",{href:!0,target:!0});var a=y(d);c=_(a,"IMG",{src:!0,class:!0,alt:!0}),a.forEach(l),m.forEach(l),this.h()},h(){n(o,"class","svelte-1pdeuuj"),G(u.src,b="/imdb.png")||n(u,"src",b),n(u,"class","img-imdb svelte-1pdeuuj"),n(u,"alt","IMDb Link"),n(h,"href",p[1].imdb_url),n(h,"target","_blank"),G(c.src,f="/rotten.png")||n(c,"src",f),n(c,"class","img-rotten svelte-1pdeuuj"),n(c,"alt","Rotten Tomatoes Link"),n(d,"href",p[1].rotten_tomatoes_url),n(d,"target","_blank"),n(e,"class","movie svelte-1pdeuuj")},m(g,m){M(g,e,m),s(e,o),s(o,T),s(e,k),s(e,h),s(h,u),s(e,E),s(e,d),s(d,c)},p:V,d(g){g&&l(e)}}}function z(p){let e,o,w,T,k,h,u,b,E,d,c,f,g,m,O,v=p[0],a=[];for(let r=0;r<v.length;r+=1)a[r]=W(R(p,v,r));return{c(){e=i("div"),o=i("div"),w=i("h2"),T=I("All-Time Movies & TV Shows"),k=I(`\r
		\xA0\r
		`),h=i("hr"),u=B(),b=i("pre"),E=I(`(in alphabetical order)\r
\r
[MOVIES]\r
\r
First-tier movies (most emotionally impactful):\r
`),d=B();for(let r=0;r<a.length;r+=1)a[r].c();c=B(),f=i("pre"),g=I(`\r
...
The Office US\r
		`),m=B(),O=i("br"),this.h()},l(r){e=_(r,"DIV",{class:!0});var S=y(e);o=_(S,"DIV",{class:!0});var t=y(o);w=_(t,"H2",{style:!0});var A=y(w);T=L(A,"All-Time Movies & TV Shows"),A.forEach(l),k=L(t,`\r
		\xA0\r
		`),h=_(t,"HR",{}),u=H(t),b=_(t,"PRE",{style:!0,class:!0});var j=y(b);E=L(j,`(in alphabetical order)\r
\r
[MOVIES]\r
\r
First-tier movies (most emotionally impactful):\r
`),j.forEach(l),d=H(t);for(let D=0;D<a.length;D+=1)a[D].l(t);c=H(t),f=_(t,"PRE",{style:!0,class:!0});var F=y(f);g=L(F,`\r
Second-tier movies (other movies):\r
\r
Die Hard\r
Office Space\r
