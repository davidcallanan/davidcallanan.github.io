import{S as W,i as N,s as q,k as l,q as P,a as B,l as w,m as y,r as I,h as i,c as H,p as D,n,b as L,E as s,A as G,L as x,C as V}from"../../../chunks/index-e9506ef8.js";function j(p,e,o){const _=p.slice();return _[1]=e[o],_}function C(p){let e,o,_=p[1].name+"",T,k,h,u,b,E,d,c,f;return{c(){e=l("div"),o=l("h1"),T=P(_),k=B(),h=l("a"),u=l("img"),E=B(),d=l("a"),c=l("img"),this.h()},l(g){e=w(g,"DIV",{class:!0});var a=y(e);o=w(a,"H1",{class:!0});var O=y(o);T=I(O,_),O.forEach(i),k=H(a),h=w(a,"A",{href:!0,target:!0});var v=y(h);u=w(v,"IMG",{src:!0,class:!0,alt:!0}),v.forEach(i),E=H(a),d=w(a,"A",{href:!0,target:!0});var m=y(d);c=w(m,"IMG",{src:!0,class:!0,alt:!0}),m.forEach(i),a.forEach(i),this.h()},h(){n(o,"class","svelte-1pdeuuj"),V(u.src,b="/imdb.png")||n(u,"src",b),n(u,"class","img-imdb svelte-1pdeuuj"),n(u,"alt","IMDb Link"),n(h,"href",p[1].imdb_url),n(h,"target","_blank"),V(c.src,f="/rotten.png")||n(c,"src",f),n(c,"class","img-rotten svelte-1pdeuuj"),n(c,"alt","Rotten Tomatoes Link"),n(d,"href",p[1].rotten_tomatoes_url),n(d,"target","_blank"),n(e,"class","movie svelte-1pdeuuj")},m(g,a){L(g,e,a),s(e,o),s(o,T),s(e,k),s(e,h),s(h,u),s(e,E),s(e,d),s(d,c)},p:G,d(g){g&&i(e)}}}function z(p){let e,o,_,T,k,h,u,b,E,d,c,f,g,a,O,v=p[0],m=[];for(let r=0;r<v.length;r+=1)m[r]=C(j(p,v,r));return{c(){e=l("div"),o=l("div"),_=l("h2"),T=P("All-Time Movies & TV Shows"),k=P(`\r
		\xA0\r
...
`),d=B();for(let r=0;r<m.length;r+=1)m[r].c();c=B(),f=l("pre"),g=P(`\r
...
The Office US\r
		`),a=B(),O=l("br"),this.h()},l(r){e=w(r,"DIV",{class:!0});var S=y(e);o=w(S,"DIV",{class:!0});var t=y(o);_=w(t,"H2",{style:!0});var A=y(_);T=I(A,"All-Time Movies & TV Shows"),A.forEach(i),k=I(t,`\r
		\xA0\r
		`),h=w(t,"HR",{}),u=H(t),b=w(t,"PRE",{style:!0,class:!0});var F=y(b);E=I(F,`(in alphabetical order)\r
\r
[MOVIES]\r
\r
First-tier movies (most emotionally impactful):\r
`),F.forEach(i),d=H(t);for(let M=0;M<m.length;M+=1)m[M].l(t);c=H(t),f=w(t,"PRE",{style:!0,class:!0});var R=y(f);g=I(R,`\r
Second-tier movies (other movies):\r
\r
Die Hard\r
Office Space\r
